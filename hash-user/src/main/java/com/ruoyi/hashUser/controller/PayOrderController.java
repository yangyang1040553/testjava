...
import com.ruoyi.hashUser.service.IPayOrderService;
...
public class PayOrderController extends BaseController
{
     ...
     * 查询充值订单记录列表
     */
    @PreAuthorize("@ss.hasPermi('hashUser:order:list')")
    @GetMapping("/list")
     ...
     * 导出充值订单记录列表
     */
    @PreAuthorize("@ss.hasPermi('hashUser:order:export')")
     ...
     * 获取充值订单记录详细信息
     */
    @PreAuthorize("@ss.hasPermi('hashUser:order:query')")
    @GetMapping(value = "/{id}")
     ...
     * 新增充值订单记录
     */
    @PreAuthorize("@ss.hasPermi('hashUser:order:add')")
     ...
     * 修改充值订单记录
     */
    @PreAuthorize("@ss.hasPermi('hashUser:order:edit')")
     ...
     * 删除充值订单记录
     */
    @PreAuthorize("@ss.hasPermi('hashUser:order:remove')")
