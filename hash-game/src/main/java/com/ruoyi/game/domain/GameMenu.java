...
public class GameMenu extends BaseEntity {
    ...
    public String getUnSelectedAddr() {
        return unSelectedAddr;
    }

    public void setUnSelectedAddr(String unSelectedAddr) {
        this.unSelectedAddr = unSelectedAddr;
    }
