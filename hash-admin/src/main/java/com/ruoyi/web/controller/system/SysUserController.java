...
public class SysUserController extends BaseController {
    ...
    @PostMapping
    public AjaxResult add(@Validated @RequestBody SysUser user, HttpServletRequest httpServletRequest) {
    ...
    @Log(title = "用户管理  密码", businessType = BusinessType.UPDATE)
    @PutMapping("/resetPwd")
     ...
     */
    @PreAuthorize("@ss.hasPermi('system:user:edit')")
    @Log(title = "用户管理  状态", businessType = BusinessType.UPDATE)
     ...
     */
    @PreAuthorize("@ss.hasPermi('system:user:edit')")
    @Log(title = "用户管理  角色", businessType = BusinessType.GRANT)
    @PutMapping("/authRole")
