 ...
 */
@RestController
@RequestMapping("/hash-wallet/walletMerchant")
public class PayMerchantController extends BaseController
{
     ...
     * 查询支付商户配置列表
     */
    @PreAuthorize("@ss.hasPermi('hash-wallet:walletMerchant:list')")
    @GetMapping("/list")
     ...
     * 导出支付商户配置列表
     */
    @PreAuthorize("@ss.hasPermi('hash-wallet:walletMerchant:export')")
     ...
     * 获取支付商户配置详细信息
     */
    @PreAuthorize("@ss.hasPermi('hash-wallet:walletMerchant:query')")
    @GetMapping(value = "/{id}")
     ...
     * 新增支付商户配置
     */
    @PreAuthorize("@ss.hasPermi('hash-wallet:walletMerchant:add')")
     ...
     * 修改支付商户配置
     */
    @PreAuthorize("@ss.hasPermi('hash-wallet:walletMerchant:edit')")
     ...
     * 删除支付商户配置
     */
    @PreAuthorize("@ss.hasPermi('hash-wallet:walletMerchant:remove')")
